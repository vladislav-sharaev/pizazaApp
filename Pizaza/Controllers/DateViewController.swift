...
class DateViewController: UIViewController {
    ...
    func updateDatePicker() {
        ...
        let plusHour = calendar.date(bySettingHour: hour, minute: minute, second: second, of: Date())
...
extension DateViewController: MapViewControllerDelegate {
...
extension DateViewController: UITextViewDelegate {
